...
class H5TrackingIterator(H5SegmentationIterator):
	...
	def _get_batches_of_transformed_samples_by_channel_neighbor(self, index_ds, index_array, chan_idx, is_input, aug_param_array, prev, perform_augmentation=True, aug_remove_prob=0.2):
