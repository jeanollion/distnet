...
class UnetDecoder():
    def __init__(self, n_up, n_filters, max_filters=0, image_shape=None,
                 ...
                 use_1x1_conv_after_concat=True, n_last_1x1_conv=0, omit_skip_connection_levels=[], batch_norm = False,
